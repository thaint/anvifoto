    ...
    <div class="ip-header">
        <h1 class="ip-logo">
            <a href="#" class="wrapper-logo">
                <svg version="1.1" id="logo-bird" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="350px" height="266px" viewBox="0 0 196 150" enable-background="new 0 0 196 150" xml:space="preserve">
